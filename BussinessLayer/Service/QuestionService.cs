    ...
    public class QuestionService : IQuestionService
    {
        ...
        public async Task<QuestionDTO> CreateQuestionAsync(CreateQuestionDTO createQuestionDTO)
        {
            try
            {
                ...
                question.IsPrivate = createQuestionDTO.IsPrivate;
        ...
        public async Task<bool> CanEditQuestionAsync(int questionId)
        {
            try
            {
                ...
                // Can edit if question is not closed and has no answers
                return !(question.IsClosed ?? false) && question.AnswerCount == 0;
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
